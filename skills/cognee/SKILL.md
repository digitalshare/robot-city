...
4. Use one session id for the conversation (your agent name + a unix timestamp) as the `session_id` in every call — the session appears automatically in the Cognee Cloud dashboard under Sessions and is converted to long-term memory
